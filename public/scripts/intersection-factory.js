...
export default class IntersectionFactory {
    createIntersection(fisrtLine, secondLine) {
        ...
        return new Intersection(new Point(fisrtLineStartX + ua * (fisrtLineEndX - fisrtLineStartX), fisrtLineStartY + ua * (fisrtLineEndY - fisrtLineStartY)), ua >= 0 && ua <= 1, ub >= 0 && ub <= 1);
    }
